...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.log('Reject Invitation API: SKIPPING token validation for debugging')
    ...
    console.log('Reject Invitation API: Updating invitation status to expired for ID:', invitationId)
    ...
    console.log('Reject Invitation API: Update result:', { updateData, updateError })
