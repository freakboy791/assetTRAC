...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const checkUser = async () => {
      try {
        ...
        if (sessionError) {
          console.log('Profile: Session validation failed:', sessionError.message)
        ...
        if (validatedSession) {
          ...
          if (activityError) {
            console.log('Profile: Activity update failed:', activityError.message)
            handleSessionError(activityError)
            return
          }
          
          // Load company data
          console.log('Profile: User authenticated, loading company data...')
  ...
  const loadCompanyData = async () => {
    try {
      ...
      console.log('Profile: Loading company data for user:', validatedSession?.user?.email)
      console.log('Profile: Validated session exists:', !!validatedSession)
      console.log('Profile: Access token exists:', !!validatedSession?.accessToken)
      ...
      console.log('Profile: Making company get API call...')
      ...
      console.log('Profile: Company get API response status:', response.status)
      if (response.ok) {
        const data = await response.json()
        console.log('Profile: Company data received:', data.company)
