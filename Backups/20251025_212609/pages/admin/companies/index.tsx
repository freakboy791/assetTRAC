  ...
  useEffect(() => {
    const checkUser = async () => {
      try {
        ...
        if (sessionError) {
          console.log('Admin Companies: Session validation failed:', sessionError.message)
        ...
        if (validatedSession && validatedSession.userData.isAdmin) {
          ...
          try {
            ...
            if (response.ok) {
              ...
              console.log('Admin Companies: Fresh user data from API:', data.user)
          ...
          if (activityError) {
            console.log('Admin Companies: Activity update failed:', activityError.message)
