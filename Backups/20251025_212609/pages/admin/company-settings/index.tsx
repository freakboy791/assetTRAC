...
export default function CompanySettingsPage() {
    ...
    const checkUser = async () => {
      try {
        ...
        try {
          ...
          if (response.ok) {
            const data = await response.json()
            console.log('Admin Company Settings: Fresh user data from API:', data.user)
  ...
  const handleEditToggle = () => {
    ...
    console.log('Edit toggle clicked, current isEditingRef:', isEditingRef.current)
    
    const newValue = !isEditing
    console.log('Setting isEditing to:', newValue)
    ...
    setTimeout(() => {
      console.log('After timeout, isEditing should be:', newValue)
      console.log('After timeout, isEditingRef should be:', isEditingRef.current)
    }, 100)
  }
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    onClick={() => {
                      ...
                      console.log('Current isEditingRef:', isEditingRef.current)
