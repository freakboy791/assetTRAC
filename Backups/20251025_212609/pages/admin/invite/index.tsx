...
export default function AdminInvitePage() {
      ...
      try {
        ...
        try {
          ...
          if (response.ok) {
            ...
            console.log('Admin Invite: Fresh user data from API:', data.user)
  ...
  const handleSendInvite = async (e: React.MouseEvent) => {
    ...
    console.log('=== FRONTEND: handleSendInvite called ===')
    ...
    try {
      ...
      console.log('=== FRONTEND: About to call /api/send-invite-email ===')
