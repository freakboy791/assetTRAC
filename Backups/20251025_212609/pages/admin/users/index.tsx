...
export default function AdminUsers() {
  ...
  useEffect(() => {
    const checkUser = async () => {
      console.log('Admin Users: Checking if user is already logged in...')
      console.log('Admin Users: Current tab ID:', getTabId())
        ...
        if (validatedSession && validatedSession.userData.isAdmin) {
          ...
          try {
            ...
            if (response.ok) {
              ...
              console.log('Admin Users: Fresh user data from API:', data.user)
