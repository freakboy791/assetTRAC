...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.log('Accept invite API: Updating invitation status to pending (will be confirmed after company creation) for token:', token)
    ...
    if (updateError) {
      ...
      console.log('Accept invite API: Invitation status updated to pending (will be confirmed after company creation)')
