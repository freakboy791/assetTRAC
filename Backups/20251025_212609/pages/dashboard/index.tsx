...
export default function DashboardPage() {
        ...
        if (validatedSession) {
          ...
          try {
            ...
            if (response.ok) {
              ...
              console.log('Dashboard: Fresh user data from API:', data.user)
              console.log('Dashboard: User first_name:', data.user.first_name)
              console.log('Dashboard: User last_name:', data.user.last_name)
              ...
              console.log('Dashboard: Using session user data:', validatedSession.user)
  ...
  const getDisplayName = () => {
    console.log('Dashboard: getDisplayName called with user:', user)
    console.log('Dashboard: user.first_name:', user?.first_name)
    console.log('Dashboard: user.last_name:', user?.last_name)
    console.log('Dashboard: user.email:', user?.email)
    
    if (user?.first_name && user?.last_name) {
      const name = `${user.first_name} ${user.last_name}`
      console.log('Dashboard: Returning full name:', name)
      return name
    } else if (user?.first_name) {
      console.log('Dashboard: Returning first name only:', user.first_name)
      return user.first_name
    } else if (user?.last_name) {
      console.log('Dashboard: Returning last name only:', user.last_name)
      return user.last_name
    } else if (user?.user_metadata?.first_name) {
      console.log('Dashboard: Returning metadata first name:', user.user_metadata.first_name)
      return user.user_metadata.first_name
    } else {
      console.log('Dashboard: Returning email as fallback:', user?.email || 'User')
