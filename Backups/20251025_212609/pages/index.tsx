      ...
      try {
        ...
        if (inviteData.invitation.status === 'pending') {
          ...
          if (error) {
            ...
            console.log('Login successful! Updating last login timestamp and redirecting to dashboard...')
            
            // Update last login timestamp
            try {
              console.log('Index: Updating last login timestamp for:', trimmedEmail)
              ...
              if (updateResponse.ok) {
                console.log('Index: Last login timestamp updated successfully')
              } else {
