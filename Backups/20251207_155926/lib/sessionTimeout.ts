...
// Export function to check if manager exists
export function hasSessionTimeoutManager(): boolean {
  return sessionTimeoutManager !== null
}

// Track active instances
export function registerSessionTimeoutInstance(): void {
  activeInstances++
}

export function unregisterSessionTimeoutInstance(): void {
  activeInstances--
