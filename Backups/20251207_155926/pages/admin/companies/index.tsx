...
export default function AdminCompaniesPage() {
  ...
  const saveCompany = async () => {
    ...
    try {
      ...
      alert('Failed to save company changes')
    }
  }
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditCompanyForm({ ...editCompanyForm, state: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editCompanyForm.zip}
                    onChange={(e) => setEditCompanyForm({ ...editCompanyForm, zip: e.target.value })}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    max="100"
                    step="0.01"
                    value={editCompanyForm.depreciation_rate}
                    onChange={(e) => setEditCompanyForm({ ...editCompanyForm, depreciation_rate: e.target.value })}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  />
                </div>
              </div>
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-indigo-600 text-white rounded-md text-sm font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
                  Save Changes
                </button>
              </div>
