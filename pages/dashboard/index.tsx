...
export default function DashboardPage() {
    ...
    const checkUser = async () => {
      ...
      try {
        ...
        if (validatedSession) {
          ...
          let userData = validatedSession.user // Default to session user
          try {
            ...
            if (response.ok) {
              ...
              userData = data.user // Store user data for later use
          ...
          // Load data for dashboard with a longer delay to ensure signin API completes first
          await loadCompanyData()
          await new Promise(resolve => setTimeout(resolve, 2000)) // 2 second delay to ensure signin API completes
          await loadRecentActivity(userData) // Pass user data directly
  ...
  const loadRecentActivity = async (userData?: any) => {
    ...
    try {
      ...
      // Use passed user data or fall back to state
      ...
      console.log('Dashboard: loadRecentActivity called with:', {
        ...
        userRolesString,
        accessToken: validatedSession?.accessToken ? 'present' : 'missing'
      })
      ...
      console.log('Dashboard: Activity API response:', {
        ok: response.ok,
      ...
      if (response.ok) {
        ...
        console.error('Dashboard: Failed to load recent activity:', response.status, response.statusText)
      }
    } catch (error) {
  ...
  const handleRefreshAll = async () => {
    ...
    try {
      await Promise.all([
        loadRecentActivity(user), // Pass current user data
        loadCompletedUsers()
      ])
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 pt-40 sm:pt-36">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            {/* Asset Management - Manager-Asset, Manager-Both, Tech, Viewer-Asset, Viewer-Both */}
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-500">
                        {userRoles.some(role => role.startsWith('viewer')) 
            ...
            {/* Work with Financials - All users with company access */}
            {hasCompany && (
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-gray-900">Work with Financials</h3>
                      <p className="text-sm text-gray-500">View asset depreciation and financial data</p>
                    </div>
                  </div>
                  <div className="mt-4">
                    <button
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                disabled={activityLoading || usersLoading}
              ...
              >
                {activityLoading || usersLoading ? 'Refreshing...' : 'Refresh'}
              </button>
            </div>
            <div className="bg-white shadow rounded-lg">
              <div className="px-6 py-4">
